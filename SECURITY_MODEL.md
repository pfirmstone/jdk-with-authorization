...
- `WorkerSubject` subtype — `Subject.callAs(...)` rejects it (see §10.1), and the scoped-subject injection path described there excludes it when building an `AccessControlContext`.
