...
- Following auditing with static analysis (https://github.com/spotbugs/spotbugs) and PolicyWriter, code that is deemed safe to run, should be run using the principle of least privilege, using policy files generated with PolicyWriter, to limit the possiblity of exploits successfully leveraging flaws in code.
