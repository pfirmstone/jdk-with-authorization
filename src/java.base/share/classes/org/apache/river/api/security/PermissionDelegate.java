 ...
 * domains (such as {@code au.zeus.jdk.authorization.sm.CombinerSecurityManager})
 * can honour delegation generically &mdash; by recognising this interface
 * rather than any concrete permission type &mdash; so that the security
 * manager need not depend on {@link DelegatePermission} or any other
