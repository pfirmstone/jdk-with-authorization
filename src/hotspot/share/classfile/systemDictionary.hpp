...
class SystemDictionary : AllStatic {
 ...
 public:
  ...
  static InstanceKlass* resolve_super_or_fail(Symbol* class_name, Symbol* super_name,
    ...
    return resolve_with_circularity_detection(class_name, super_name, class_loader, protection_domain, is_superclass, THREAD);
  }
...
private:
  ...
  static bool check_shared_class_super_type(InstanceKlass* klass, InstanceKlass* super,
                                            Handle class_loader, Handle protection_domain,
                                            bool is_superclass, TRAPS);
  static bool check_shared_class_super_types(InstanceKlass* ik, Handle class_loader, Handle protection_domain, TRAPS);
