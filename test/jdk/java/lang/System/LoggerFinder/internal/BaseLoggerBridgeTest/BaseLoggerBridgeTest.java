 ...
 * @run  main/othervm/policy=security.policy -Djava.security.manager=allow -Djava.system.class.loader=CustomSystemClassLoader BaseLoggerBridgeTest NOPERMISSIONS
 * @run  main/othervm/policy=security.policy -Djava.security.manager=allow -Djava.system.class.loader=CustomSystemClassLoader BaseLoggerBridgeTest WITHPERMISSIONS
 * @author danielfuchs
 */
