 ...
 * @run main/othervm/timeout=480 --add-modules=ALL-SYSTEM FieldSetAccessibleTest UNSECURE
 * @run main/othervm/timeout=480 --add-modules=ALL-SYSTEM -Djava.security.manager=allow FieldSetAccessibleTest SECURE
 *
 * @author danielfuchs
 */
